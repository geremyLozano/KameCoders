        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 400px;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="pagoModalLabel">Pago con Tarjeta de Crédito</h5>
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <!-- Recuadro de monto a pagar -->
                        <div class="text-center mt-2 mb-3" style="background-color: #d4f1f4; border-radius: 5px; padding: 8px;">
                            <strong>Total a Pagar: S/150</strong>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                    <button type="button" class="btn btn-primary" runat="server" onserverclick="ProcesarPago_Click"><strong>Procesar Pago</strong></button>
                </div>
            </div>
        </div>
    </div>
